...
import java.util.List;
@Service
public class SystemeManagementAdminServiceImpl implements SystemeManagementAdminService {
    ...
    public SystemeManagementAdminServiceImpl(SystemeManagementDao dao) {
        this.dao = dao;
    }
