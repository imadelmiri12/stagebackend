package ma.zyn.app.service.impl.collaborator.indicateur;
...
import java.util.List;
@Service
public class TrimestreCollaboratorServiceImpl implements TrimestreCollaboratorService {
    ...
    public TrimestreCollaboratorServiceImpl(TrimestreDao dao) {
        this.dao = dao;
    }
