...
import java.util.List;
@Service
public class ResultatEvaluationCollaboratorServiceImpl implements ResultatEvaluationCollaboratorService {
    ...
    public ResultatEvaluationCollaboratorServiceImpl(ResultatEvaluationDao dao) {
        this.dao = dao;
    }
