...
import java.util.List;
@Service
public class CritereEvaluationAdminServiceImpl implements CritereEvaluationAdminService {
    ...
    public CritereEvaluationAdminServiceImpl(CritereEvaluationDao dao) {
        this.dao = dao;
    }
