...
import ma.zyn.app.service.facade.collaborator.mensuel.RapportEvenementMensuelTypeEvenementCollaboratorService ;
...
import java.util.List;
@Service
public class RapportEvenementMensuelCollaboratorServiceImpl implements RapportEvenementMensuelCollaboratorService {
    ...
    @Autowired
    private RapportEvenementMensuelTypeEvenementCollaboratorService rapportEvenementMensuelTypeEvenementService ;
    @Autowired
    private RapportEvenementMensuelSecteurCollaboratorService rapportEvenementMensuelSecteurService ;

    public RapportEvenementMensuelCollaboratorServiceImpl(RapportEvenementMensuelDao dao) {
        this.dao = dao;
    }
