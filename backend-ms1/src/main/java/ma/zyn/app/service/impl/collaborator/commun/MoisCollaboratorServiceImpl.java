...
import ma.zyn.app.service.facade.collaborator.commun.MoisCollaboratorService;
...
import ma.zyn.app.service.facade.collaborator.indicateur.TrimestreCollaboratorService ;
import ma.zyn.app.bean.core.indicateur.Trimestre ;

import java.util.List;
@Service
public class MoisCollaboratorServiceImpl implements MoisCollaboratorService {
    ...
    @Autowired
    private TrimestreCollaboratorService trimestreService ;

    public MoisCollaboratorServiceImpl(MoisDao dao) {
        this.dao = dao;
    }
