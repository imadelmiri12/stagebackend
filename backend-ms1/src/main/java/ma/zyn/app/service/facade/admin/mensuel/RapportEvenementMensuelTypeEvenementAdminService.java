...
public interface RapportEvenementMensuelTypeEvenementAdminService {
    ...
    RapportEvenementMensuelTypeEvenement findByRapportEvenementMensuelIdAndTypeEvenementId(Long id, Long id1);
}
