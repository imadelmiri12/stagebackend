...
import java.util.List;
@Service
public class RapportEvenementMensuelSecteurDetailCollaboratorServiceImpl implements RapportEvenementMensuelSecteurDetailCollaboratorService {
    ...
    public RapportEvenementMensuelSecteurDetailCollaboratorServiceImpl(RapportEvenementMensuelSecteurDetailDao dao) {
        this.dao = dao;
    }
