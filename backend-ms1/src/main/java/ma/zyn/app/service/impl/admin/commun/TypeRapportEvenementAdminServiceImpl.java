...
import java.util.List;
@Service
public class TypeRapportEvenementAdminServiceImpl implements TypeRapportEvenementAdminService {
    ...
    public TypeRapportEvenementAdminServiceImpl(TypeRapportEvenementDao dao) {
        this.dao = dao;
    }
