...
import java.util.List;
@Service
public class TypeEvenementCollaboratorServiceImpl implements TypeEvenementCollaboratorService {
    ...
    public TypeEvenementCollaboratorServiceImpl(TypeEvenementDao dao) {
        this.dao = dao;
    }
