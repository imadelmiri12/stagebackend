...
import java.util.List;
@Service
public class RapportEvenementMensuelSecteurAdminServiceImpl implements RapportEvenementMensuelSecteurAdminService {
    ...
    @Override
    public RapportEvenementMensuelSecteur findByRapportEvenementMensuelIdAndSecteurId(Long rapportEvenementMensuelId, Long secteurId) {
        return dao.findByRapportEvenementMensuelIdAndSecteurId(rapportEvenementMensuelId,secteurId);
    }
    ...
    @Autowired
    private RapportEvenementMensuelSecteurDetailAdminService rapportEvenementMensuelSecteurDetailService ;
    @Autowired
    private SecteurAdminService secteurService ;

    public RapportEvenementMensuelSecteurAdminServiceImpl(RapportEvenementMensuelSecteurDao dao) {
        this.dao = dao;
    }
