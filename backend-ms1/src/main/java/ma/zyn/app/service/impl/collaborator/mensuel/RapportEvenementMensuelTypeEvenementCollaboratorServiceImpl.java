...
import java.util.List;
@Service
public class RapportEvenementMensuelTypeEvenementCollaboratorServiceImpl implements RapportEvenementMensuelTypeEvenementCollaboratorService {
    ...
    public RapportEvenementMensuelTypeEvenementCollaboratorServiceImpl(RapportEvenementMensuelTypeEvenementDao dao) {
        this.dao = dao;
    }
