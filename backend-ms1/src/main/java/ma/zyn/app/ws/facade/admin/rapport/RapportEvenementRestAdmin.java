package  ma.zyn.app.ws.facade.admin.rapport;
...
@RestController
@RequestMapping("/api/admin/rapportEvenement/")
public class RapportEvenementRestAdmin {
   ...
   public RapportEvenementRestAdmin(RapportEvenementAdminService service, RapportEvenementConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final RapportEvenementAdminService service;
