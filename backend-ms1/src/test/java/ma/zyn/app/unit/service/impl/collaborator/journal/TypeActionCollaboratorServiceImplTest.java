...
import ma.zyn.app.service.impl.collaborator.journal.TypeActionCollaboratorServiceImpl;
...
@SpringBootTest
class TypeActionCollaboratorServiceImplTest {

    @Mock
    private TypeActionDao repository;
    private AutoCloseable autoCloseable;
    private TypeActionCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TypeActionCollaboratorServiceImpl(repository);
    }
