package ma.zyn.app.unit.ws.facade.collaborator.rapport;
...
import ma.zyn.app.ws.facade.collaborator.rapport.RapportEvenementRestCollaborator;
...
public class RapportEvenementRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private RapportEvenementCollaboratorServiceImpl service;
    @Mock
    private RapportEvenementConverter converter;

    @InjectMocks
    private RapportEvenementRestCollaborator controller;
