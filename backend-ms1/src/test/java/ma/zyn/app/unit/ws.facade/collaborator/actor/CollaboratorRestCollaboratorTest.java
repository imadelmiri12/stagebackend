package ma.zyn.app.unit.ws.facade.collaborator.actor;

import ma.zyn.app.bean.core.actor.Collaborator;
import ma.zyn.app.service.impl.collaborator.actor.CollaboratorCollaboratorServiceImpl;
import ma.zyn.app.ws.facade.collaborator.actor.CollaboratorRestCollaborator;
...
public class CollaboratorRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private CollaboratorCollaboratorServiceImpl service;
    @Mock
    private CollaboratorConverter converter;

    @InjectMocks
    private CollaboratorRestCollaborator controller;
