...
@SpringBootTest
class JournalAmelioarationAdminServiceImplTest {

    @Mock
    private JournalAmelioarationDao repository;
    private AutoCloseable autoCloseable;
    private JournalAmelioarationAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new JournalAmelioarationAdminServiceImpl(repository);
    }
