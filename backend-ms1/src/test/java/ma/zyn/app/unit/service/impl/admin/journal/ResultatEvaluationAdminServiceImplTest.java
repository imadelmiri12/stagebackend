...
@SpringBootTest
class ResultatEvaluationAdminServiceImplTest {

    @Mock
    private ResultatEvaluationDao repository;
    private AutoCloseable autoCloseable;
    private ResultatEvaluationAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new ResultatEvaluationAdminServiceImpl(repository);
    }
