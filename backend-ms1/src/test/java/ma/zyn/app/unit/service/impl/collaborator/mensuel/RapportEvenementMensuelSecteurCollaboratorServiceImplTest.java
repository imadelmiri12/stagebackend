...
import ma.zyn.app.service.impl.collaborator.mensuel.RapportEvenementMensuelSecteurCollaboratorServiceImpl;
...
@SpringBootTest
class RapportEvenementMensuelSecteurCollaboratorServiceImplTest {

    @Mock
    private RapportEvenementMensuelSecteurDao repository;
    private AutoCloseable autoCloseable;
    private RapportEvenementMensuelSecteurCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new RapportEvenementMensuelSecteurCollaboratorServiceImpl(repository);
    }
