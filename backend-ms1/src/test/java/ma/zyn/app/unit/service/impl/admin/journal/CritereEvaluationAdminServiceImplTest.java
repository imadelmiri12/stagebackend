...
@SpringBootTest
class CritereEvaluationAdminServiceImplTest {

    @Mock
    private CritereEvaluationDao repository;
    private AutoCloseable autoCloseable;
    private CritereEvaluationAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new CritereEvaluationAdminServiceImpl(repository);
    }
