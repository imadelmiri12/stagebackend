...
@SpringBootTest
class RapportEvenementMensuelSecteurDetailAdminServiceImplTest {

    @Mock
    private RapportEvenementMensuelSecteurDetailDao repository;
    private AutoCloseable autoCloseable;
    private RapportEvenementMensuelSecteurDetailAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new RapportEvenementMensuelSecteurDetailAdminServiceImpl(repository);
    }
