package ma.zyn.app.unit.service.impl.admin.indicateur;
...
@SpringBootTest
class TrimestreAdminServiceImplTest {

    @Mock
    private TrimestreDao repository;
    private AutoCloseable autoCloseable;
    private TrimestreAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new TrimestreAdminServiceImpl(repository);
    }
