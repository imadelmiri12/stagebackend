package ma.zyn.app.unit.service.impl.admin.rapport;
...
@SpringBootTest
class RapportEvenementAdminServiceImplTest {

    @Mock
    private RapportEvenementDao repository;
    private AutoCloseable autoCloseable;
    private RapportEvenementAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new RapportEvenementAdminServiceImpl(repository);
    }
