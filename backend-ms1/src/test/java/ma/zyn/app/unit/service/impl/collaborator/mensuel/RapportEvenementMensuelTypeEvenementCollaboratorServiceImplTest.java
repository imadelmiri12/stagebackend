...
import ma.zyn.app.service.impl.collaborator.mensuel.RapportEvenementMensuelTypeEvenementCollaboratorServiceImpl;
...
@SpringBootTest
class RapportEvenementMensuelTypeEvenementCollaboratorServiceImplTest {

    @Mock
    private RapportEvenementMensuelTypeEvenementDao repository;
    private AutoCloseable autoCloseable;
    private RapportEvenementMensuelTypeEvenementCollaboratorServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new RapportEvenementMensuelTypeEvenementCollaboratorServiceImpl(repository);
    }
