...
@SpringBootTest
class SystemeManagementAdminServiceImplTest {

    @Mock
    private SystemeManagementDao repository;
    private AutoCloseable autoCloseable;
    private SystemeManagementAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new SystemeManagementAdminServiceImpl(repository);
    }
