...
@SpringBootTest
class RapportEvenementMensuelAdminServiceImplTest {

    @Mock
    private RapportEvenementMensuelDao repository;
    private AutoCloseable autoCloseable;
    private RapportEvenementMensuelAdminServiceImpl underTest;
    ...
    void setUp() {
        ...
        underTest = new RapportEvenementMensuelAdminServiceImpl(repository);
    }
